...
<!-- adicionando referencia para as bibliotecas 
de CSS (folha de estilo) -->
...
<body>
	...
	<div class="container mt-3">
		...
		<div class="row">
			<div class="col-md-6">
				...
				<p>
					<a href="http://www.cotiinformatica.com.br" target="_blank">COTI
						Informática</a>
				</p>
				...
				Usuário autenticado: <strong>${user_auth.nome}</strong> <br />
	...
	<!-- adicionando referencia para 
as bibliotecas de JS (javascript) -->
