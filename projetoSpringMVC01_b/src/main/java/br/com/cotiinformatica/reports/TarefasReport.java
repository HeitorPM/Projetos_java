...
public class TarefasReport {
	...
	// ByteArrayInputStream --> retornar um arquivo em memória (formato batch)
	public static ByteArrayInputStream getPdf(Date dataMin, Date dataMax, List<Tarefa> tarefas, Usuario usuario)
		...
		for (Tarefa tarefa : tarefas) {
			...
			// esse toString vem da superclasse enum
	...
	//método para formatar o texto do relatorio
