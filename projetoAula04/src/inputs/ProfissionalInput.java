...
public class ProfissionalInput {
	...
	public static String lerNome() throws Exception {
		...
		if (nome.length() < 10 || nome.length() > 100)
			throw new Exception("O nome deve conter entre 10 a 100 caracteres.");
	...
	public static String lerTelefone() throws Exception {
		String telefone = JOptionPane.showInputDialog("Informe o celular do profissional:").trim();

		if (telefone.length() != 9)
			throw new Exception("O celular deve conter exatamente 9 digitos.");
